...
$(document).ready(function(){
  ...
  document.onkeyup = function (data) {
    if (data.which == 27 ) {
      $.post('http://dbank/close', JSON.stringify({}));
    }
  };
  // Handle Button Presses
  $(".btnWithdraw").click(function(){
      $.post('http://dbank/withdraw', JSON.stringify({}));
  });
  $(".btnDeposit").click(function(){
      $.post('http://dbank/deposit', JSON.stringify({}));
  });
  $(".btnTransfer").click(function(){
      $.post('http://dbank/transfer', JSON.stringify({}));
  });
  $(".btnBalance").click(function(){
      $.post('http://dbank/balance', JSON.stringify({}));
  });
  $('.btnQuick').click($.throttle( 2000, true, function(e){
    $.post('http://dbank/quickCash', JSON.stringify({}));
  }));
  ...
  $("#withdraw-form").submit(function(e) {
      e.preventDefault();
      $.post('http://dbank/withdrawSubmit', JSON.stringify({
  ...
  $("#deposit-form").submit(function(e) {
      e.preventDefault();
      $.post('http://dbank/depositSubmit', JSON.stringify({
  ...
  $("#transfer-form").submit(function(e) {
      e.preventDefault();
      $.post('http://dbank/transferSubmit', JSON.stringify({
