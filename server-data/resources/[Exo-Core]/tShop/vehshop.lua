...
local vehshop = {
	...
	menu = {
		...
		["compacts"] = {
			...
			name = "compacts",
			buttons = {
				{name = "Blista", costs = 10000, description = {}, model = "blista"},
				{name = "Brioso R/A", costs = 25000, description = {}, model = "brioso"},
				{name = "Dilettante", costs = 6000, description = {}, model = "Dilettante"},
				{name = "Issi", costs = 18000, description = {}, model = "issi2"},
				{name = "Panto", costs = 6500, description = {}, model = "panto"},
				{name = "Prairie", costs = 27000, description = {}, model = "prairie"},
		...
		["coupes"] = {
			...
			name = "coupes",
			buttons = {
				{name = "Cognoscenti Cabrio", costs = 130000, description = {}, model = "cogcabrio"},
				{name = "Exemplar", costs = 160000, description = {}, model = "exemplar"},
				{name = "F620", costs = 150000, description = {}, model = "f620"},
				{name = "Felon", costs = 90000, description = {}, model = "felon"},
				{name = "Felon GT", costs = 110000, description = {}, model = "felon2"},
				...
				{name = "Sentinel", costs = 100000, description = {}, model = "sentinel"},
				{name = "Sentinel XS", costs = 110000, description = {}, model = "sentinel2"},
				{name = "Windsor", costs = 350000, description = {}, model = "windsor"},
		...
		["sports"] = {
			...
			name = "sports",
			buttons = {
				{name = "9F", costs = 800000, description = {}, model = "ninef"},
				{name = "9F Cabrio", costs = 830000, description = {}, model = "ninef2"},
				{name = "Alpha", costs = 190000, description = {}, model = "alpha"},
				{name = "Banshee", costs = 650000, description = {}, model = "banshee"},
				{name = "Bestia GTS", costs = 650000, description = {}, model = "bestiagts"},
				--{name = "Blista Compact", costs = 42000, description = {}, model = "blista"},
				{name = "Buffalo", costs = 150000, description = {}, model = "buffalo"},
				{name = "Buffalo S", costs = 180000, description = {}, model = "buffalo2"},
				{name = "Carbonizzare", costs = 810000, description = {}, model = "carbonizzare"},
				{name = "Comet", costs = 730000, description = {}, model = "comet2"},
				{name = "Coquette", costs = 780000, description = {}, model = "coquette"},
				{name = "Drift Tampa", costs = 230000, description = {}, model = "tampa2"},
				{name = "Feltzer", costs = 680000, description = {}, model = "feltzer2"},
				{name = "Furore GT", costs = 650000, description = {}, model = "furoregt"},
				{name = "Fusilade", costs = 160000, description = {}, model = "fusilade"},
				{name = "Jester", costs = 800000, description = {}, model = "jester"},
				{name = "Jester(Racecar)", costs = 900000, description = {}, model = "jester2"},
				{name = "Kuruma", costs = 450000, description = {}, model = "kuruma"},
				{name = "Lynx", costs = 720000, description = {}, model = "lynx"},
				{name = "Massacro", costs = 650000, description = {}, model = "massacro"},
				{name = "Massacro(Racecar)", costs = 700000, description = {}, model = "massacro2"},
				{name = "Omnis", costs = 500000, description = {}, model = "omnis"},
				{name = "Penumbra", costs = 110000, description = {}, model = "penumbra"},
				{name = "Rapid GT", costs = 550000, description = {}, model = "rapidgt"},
				{name = "Rapid GT Convertible", costs = 580000, description = {}, model = "rapidgt2"},
				{name = "Schafter V12", costs = 90000, description = {}, model = "schafter3"},
				{name = "Sultan", costs = 90000, description = {}, model = "sultan"},
				{name = "Surano", costs = 750000, description = {}, model = "surano"},
				{name = "Tropos", costs = 600000, description = {}, model = "tropos"},
				{name = "Verkierer", costs = 800000, description = {}, model = "verlierer2"},
			}
		},
		["sportsclassics"] = {
			...
			name = "sportsclassics",
			buttons = {
				{name = "Casco", costs = 800000, description = {}, model = "casco"},
				{name = "Coquette Classic", costs = 850000, description = {}, model = "coquette2"},
				{name = "JB 700", costs = 820000, description = {}, model = "jb700"},
				{name = "Pigalle", costs = 700000, description = {}, model = "pigalle"},
				{name = "Stinger", costs = 705000, description = {}, model = "stinger"},
		...
		["super"] = {
			...
			buttons = {
				...
				{name = "Banshee 900R", costs = 700000, description = {}, model = "banshee2"},
				{name = "Bullet", costs = 680000, description = {}, model = "bullet"},
				{name = "Cheetah", costs = 930000, description = {}, model = "cheetah"},
				{name = "Entity XF", costs = 950000, description = {}, model = "entityxf"},
				{name = "ETR1", costs = 970000, description = {}, model = "sheava"},
				{name = "FMJ", costs = 980000, description = {}, model = "fmj"},
				{name = "Infernus", costs = 800000, description = {}, model = "infernus"},
				{name = "Osiris", costs = 1300000, description = {}, model = "osiris"},
				{name = "RE-7B", costs = 2000000, description = {}, model = "le7b"},
				{name = "Reaper", costs = 980000, description = {}, model = "reaper"},
				{name = "Sultan RS", costs = 180000, description = {}, model = "sultanrs"},
				{name = "T20", costs = 1200000, description = {}, model = "t20"},
				{name = "Turismo R", costs = 990000, description = {}, model = "turismor"},
				{name = "Tyrus", costs = 750000, description = {}, model = "tyrus"},
				{name = "Vacca", costs = 950000, description = {}, model = "vacca"},
				{name = "Voltic", costs = 580000, description = {}, model = "voltic"},
				{name = "X80 Proto", costs = 2000000, description = {}, model = "prototipo"},
				{name = "Zentorno", costs = 1100000, description = {}, model = "zentorno"},
			}
		},
		["muscle"] = {
			title = "muscle",
			name = "muscle",
			buttons = {
				{name = "Blade", costs = 150000, description = {}, model = "blade"},
				{name = "Buccaneer", costs = 140000, description = {}, model = "buccaneer"},
				{name = "Chino", costs = 170000, description = {}, model = "chino"},
				{name = "Coquette BlackFin", costs = 290000, description = {}, model = "coquette3"},
				{name = "Dominator", costs = 190000, description = {}, model = "dominator"},
				{name = "Dukes", costs = 170000, description = {}, model = "dukes"},
				{name = "Gauntlet", costs = 140000, description = {}, model = "gauntlet"},
				{name = "Hotknife", costs = 140000, description = {}, model = "hotknife"},
				{name = "Faction", costs = 150000, description = {}, model = "faction"},
				{name = "Nightshade", costs = 180000, description = {}, model = "nightshade"},
				{name = "Picador", costs = 80000, description = {}, model = "picador"},
				{name = "Sabre Turbo", costs = 130000, description = {}, model = "sabregt"},
				{name = "Tampa", costs = 110000, description = {}, model = "tampa"},
				{name = "Virgo", costs = 160000, description = {}, model = "virgo"},
				{name = "Vigero", costs = 170000, description = {}, model = "vigero"},
			}
		},
		["offroad"] = {
			title = "off-road",
			name = "off-road",
			buttons = {
				{name = "Bifta", costs = 100000, description = {}, model = "bifta"},
				{name = "Blazer", costs = 30000, description = {}, model = "blazer"},
				{name = "Brawler", costs = 120000, description = {}, model = "brawler"},
				{name = "Bubsta 6x6", costs = 90000, description = {}, model = "dubsta3"},
				{name = "Dune Buggy", costs = 40000, description = {}, model = "dune"},
				{name = "Rebel", costs = 75000, description = {}, model = "rebel2"},
				{name = "Sandking", costs = 80000, description = {}, model = "sandking"},
				--{name = "The Liberator", costs = 550000, description = {}, model = "monster"},
				{name = "Trophy Truck", costs = 350000, description = {}, model = "trophytruck"},
			}
		},
		["suvs"] = {
			title = "suvs",
			...
			buttons = {
				...
				{name = "Grabger", costs = 50000, description = {}, model = "granger"},
				{name = "Huntley S", costs = 85000, description = {}, model = "huntley"},
				{name = "Landstalker", costs = 65000, description = {}, model = "landstalker"},
				{name = "Radius", costs = 47000, description = {}, model = "radi"},
				{name = "Rocoto", costs = 95000, description = {}, model = "rocoto"},
		...
		["vans"] = {
			...
			name = "vans",
			buttons = {
				{name = "Bison", costs = 26000, description = {}, model = "bison"},
				...
				{name = "Minivan", costs = 9000, description = {}, model = "minivan"},
				{name = "Paradise", costs = 22000, description = {}, model = "paradise"},
				{name = "Rumpo", costs = 20000, description = {}, model = "rumpo"},
				{name = "Surfer", costs = 13000, description = {}, model = "surfer"},
				{name = "Youga", costs = 14000, description = {}, model = "youga"},
			}
		},
		["sedans"] = {
			title = "sedans",
			name = "sedans",
			buttons = {
				{name = "Asea", costs = 22000, description = {}, model = "asea"},
				{name = "Asterope", costs = 25000, description = {}, model = "asterope"},
				{name = "Fugitive", costs = 40000, description = {}, model = "fugitive"},
				{name = "Glendale", costs = 30000, description = {}, model = "glendale"},
				{name = "Ingot", costs = 12000, description = {}, model = "ingot"},
				{name = "Intruder", costs = 21000, description = {}, model = "intruder"},
				{name = "Premier", costs = 21000, description = {}, model = "premier"},
				{name = "Primo", costs = 19000, description = {}, model = "primo"},
				{name = "Primo Custom", costs = 22000, description = {}, model = "primo2"},
				{name = "Regina", costs = 9000, description = {}, model = "regina"},
				{name = "Schafter", costs = 22000, description = {}, model = "schafter2"},
				{name = "Stanier", costs = 23000, description = {}, model = "stanier"},
				{name = "Stratum", costs = 12000, description = {}, model = "stratum"},
				{name = "Stretch", costs = 600000, description = {}, model = "stretch"},
				{name = "Super Diamond", costs = 300000, description = {}, model = "superd"},
				{name = "Surge", costs = 7500, description = {}, model = "surge"},
				{name = "Tailgater", costs = 31000, description = {}, model = "tailgater"},
				{name = "Warrener", costs = 30000, description = {}, model = "warrener"},
				{name = "Washington", costs = 24000, description = {}, model = "washington"},
			}
		},
		["motorcycles"] = {
			title = "MOTORCYCLES",
			name = "motorcycles",
			buttons = {
				{name = "Akuma", costs = 17000, description = {}, model = "AKUMA"},
				{name = "Bagger", costs = 8000, description = {}, model = "bagger"},
				{name = "Bati 801", costs = 18000, description = {}, model = "bati"},
				{name = "Bati 801RR", costs = 24000, description = {}, model = "bati2"},
				{name = "BF400", costs = 16000, description = {}, model = "bf400"},
				{name = "Carbon RS", costs = 30000, description = {}, model = "carbonrs"},
				{name = "Cliffhanger", costs = 29000, description = {}, model = "cliffhanger"},
				{name = "Daemon", costs = 12000, description = {}, model = "daemon"},
				{name = "Double T", costs = 33000, description = {}, model = "double"},
				{name = "Enduro", costs = 11000, description = {}, model = "enduro"},
				...
				{name = "Hexer", costs = 16000, description = {}, model = "hexer"},
				{name = "Innovation", costs = 18000, description = {}, model = "innovation"},
				{name = "Lectro", costs = 35000, description = {}, model = "lectro"},
				{name = "Nemesis", costs = 32000, description = {}, model = "nemesis"},
				{name = "PCJ-600", costs = 33000, description = {}, model = "pcj"},
				{name = "Ruffian", costs = 34500, description = {}, model = "ruffian"},
				{name = "Sanchez", costs = 17000, description = {}, model = "sanchez"},
				{name = "Sovereign", costs = 19000, description = {}, model = "sovereign"},
				{name = "Thrust", costs = 26000, description = {}, model = "thrust"},
				{name = "Vader", costs = 34000, description = {}, model = "vader"},
				{name = "Vindicator", costs = 48000, description = {}, model = "vindicator"},
			}
		},
	}
}
